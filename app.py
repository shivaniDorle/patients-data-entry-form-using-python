...
Label(root, text="Please fill out this Entry form:", font="arial 13", bg="#326273", fg="#fff").place(x=340, y=20)

Label(root, text='Name', font=23, bg="#326273", fg="#fff").place(x=50, y=70)
Label(root, text='Contact No', font=23, bg="#326273", fg="#fff").place(x=50, y=120)
Label(root, text='Age', font=23, bg="#326273", fg="#fff").place(x=50, y=170)
Label(root, text='Gender', font=23, bg="#326273", fg="#fff").place(x=390, y=170)
Label(root, text='Occupation', font=23, bg="#326273", fg="#fff").place(x=50, y=220)
Label(root, text='Address', font=23, bg="#326273", fg="#fff").place(x=50, y=270)
Label(root, text='Cause', font=23, bg="#326273", fg="#fff").place(x=50, y=320)
Label(root, text='Past History', font=23, bg="#326273", fg="#fff").place(x=50, y=370)
Label(root, text='Family History', font=23, bg="#326273", fg="#fff").place(x=50, y=420)
Label(root, text='Treatment Date', font=23, bg="#326273", fg="#fff").place(x=50, y=470)
...
selected_date_label = Label(root, text="Selected Date:", font=23, bg="#326273", fg="#fff")
selected_date_label.place(x=200, y=500)
Label(root, text='Treatment', font=23, bg="#326273", fg="#fff").place(x=50, y=550)
Label(root, text="Fees", font=23, bg="#326273", fg="#fff").place(x=50, y=610)
nameValue = StringVar()
